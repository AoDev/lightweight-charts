---
id: customization-chart
title: "Chart customization"
sidebar_label: "Chart customization"
---
...
|`mode`|[PriceScaleMode](./customization-constants.md#pricescalemode) |`PriceScaleMode.Normal`|Sets the price scale mode|
...
|`style`|[LineStyle](./customization-constants.md#linestyle)|`LineStyle.Dashed`|Crosshair line style|
...
|`mode`|[CrosshairMode](./customization-constants.md#crosshairmode)|`CrosshairMode.Magnet`|Sets the mode of crosshair moving.|
...
|`style`|[LineStyle](./customization-constants.md#linestyle)|`LineStyle.Solid`|Grid lines style|
