...
|`priceLineSource`|[PriceLineSource](./customization-constants.md#pricelinesource)|`PriceLineSource.LastBar`|Source to be used for the horizontal price line|
|`priceLineWidth`|`number`|`1`|Price line's width in pixels|
|`priceLineColor`|`string`|`''`|Price line's color|
|`priceLineStyle`|[LineStyle](./customization-constants.md#linestyle)|`LineStyle.Dotted`|Price line's style|
...
|`baseLineStyle`|[LineStyle](./customization-constants.md#linestyle)|`LineStyle.Solid`|Base line's style|
...
|`lineStyle`|[LineStyle](./customization-constants.md#linestyle)|`LineStyle.Solid`|Price line's style|
