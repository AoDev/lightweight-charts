...
Where `timePoint` is [Time](./data-time.md) object, `type` is [TickMarkType](./customization-constants.md#TickMarkType) enum and `locale` is the currently applied locale of the string type.
